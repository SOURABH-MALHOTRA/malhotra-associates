        ...
        <div className="container mx-auto px-4 text-center relative z-10">
          <div className="max-w-4xl mx-auto">
            ...
            <div className="flex flex-wrap gap-4 justify-center">
              ...
              <button className="px-10 py-5 bg-white/20 backdrop-blur-md text-white rounded-xl font-bold text-lg border-2 border-white/40 hover:bg-white/30 transition-all duration-300">
                View Portfolio
              </button>
            </div>
          </div>
